...
bool verifyBip39(std::string phrase, std::string password = "", unsigned int wordlength = 12);
...
/** \brief The BIP39 US Wordlist
 */
const std::string US_EN_Wordlist[2048] = {"abandon",
"ability",
"able",
"about",
"above",
